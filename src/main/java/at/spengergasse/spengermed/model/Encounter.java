...
public class Encounter extends DomainResource {
	...
	@JoinColumn(name = "i_encounter_id", referencedColumnName = "id")
	...
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "sh_encounter_id", referencedColumnName = "id")
	private List<StatusHistory> statusHistory = new ArrayList<>();
	
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "cc_encounter_id", referencedColumnName = "id")
	private List<CodeableConcept> type = new ArrayList<>();
	
	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name = "enc_subject_reference_id", referencedColumnName = "id")
	private Reference subject;
	
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "enc_epOfCa_reference_id", referencedColumnName = "id")
	private List<Reference> episodeOfCare = new ArrayList<>();
	
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "part_encounter_id", referencedColumnName = "id")
	private List<Participant> participant = new ArrayList<>();
	
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "ref_encounter_appointment_id", referencedColumnName = "id")
	private List<Reference> appointment = new ArrayList<>();

	@OneToOne(cascade = CascadeType.ALL)
	@JoinColumn(name="ref_period_id", referencedColumnName="id")
	private Period period;
	
	@OneToMany(cascade = CascadeType.ALL)
	@JoinColumn(name = "ref_encounter_reason_id", referencedColumnName = "id")
