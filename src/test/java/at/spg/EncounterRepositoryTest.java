...
public class EncounterRepositoryTest {
    ...
    public static Encounter returnOneEncounter(){
        ...
        identifier1.setCode(Identifier.UseCode.old);
        ...
        identifier2.setCode(Identifier.UseCode.old);
        ...
        identifier3.setCode(Identifier.UseCode.old);
        ...
        identifier4.setCode(Identifier.UseCode.old);
        ...
        Identifier i2 = new Identifier(Identifier.UseCode.official,ccType, "System", "value", period);
        Identifier i3 = new Identifier(Identifier.UseCode.official,ccType, "System", "value", period);
        Identifier i4 = new Identifier(Identifier.UseCode.official,ccType, "System", "value", period);
        Identifier i5 = new Identifier(Identifier.UseCode.official,ccType, "System", "value", period);

        statusHistory.add(new StatusHistory(StatusHistory.EncounterStatus.finished, period));
        episodeOfCare.add(new Reference("/api/episode", "EpisodeOfCare", i2, "alternative"));
        participants.add(new Participant(cc, period, r1));
        appointment.add(new Reference("/api/references/ref1", "Appointment", i3, "Liste der bisherigen Termine"));
        reasonReference.add(new Reference("/api/procedures/proc1", "Procedure", i4, "Grund"));
